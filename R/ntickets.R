...
#' @param gamma probability of overbooking completely
#' @param p probability of show up
#'
#'
#' @return returns 2 way estimated values for number of tickets to sell and  graph of discrete and continuous
#' @export
#'
#' @examples
...
ntickets <- function(N,gamma,p) {
  ...
  f1<-function(n)(1-gamma-pnorm(N,(n-0.5)*p,sqrt((n-0.5)*p*(1-p))))


  curve(f1,xlim=c(N,(N+N/10)),xlab="n", ylab="Objective")
  ...
  ans<-list(nd=nd, nc = nc, N = N, p = p, gamma = gamma)
  print(ans)
}
